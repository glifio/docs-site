...
8. 已向 GLIF 付款（参见 [第八部分](glif-agent-wang-zhan-jiao-cheng-8-fu-kuan.md)）
...
![第一步：发起更改操作员提案](../../../.gitbook/assets/image (17).png)

3. 在“**更改您的Agent的操作员**”多签提案界面中，输入新的操作员地址。
4. 点击“**发送**”，并在钱包中批准交易。

![第一步：发起更改操作员提案](../../../.gitbook/assets/image (19).png)

5. 等待交易完成。一个“**Transfer Operator**”提案将显示在“**Agent 拥有者提案**”部分。

![第一步：发起更改操作员提案](https://2973863842-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6Q2zGcG6QOSRYiiZgFn5%2Fuploads%2F4HDe99Mj8BtgO1YjhG2X%2Fimage.png?alt=media&#x26;token=a021d5be-dd67-49fe-b313-421565e793dd)
...
![第二步：审批提案](https://docs.glif.io/~gitbook/image?url=https%3A%2F%2F484526191-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FK9YeiXXsxoIUAOwehHCZ%252Fuploads%252FXqNi6nm48CFDt2XJders%252Fimage.png%3Falt%3Dmedia%26token%3D8841318c-dd3e-4f65-b87c-74cd23ea65e7&#x26;width=768&#x26;dpr=4&#x26;quality=100&#x26;sign=2c9ba56a&#x26;sv=2)
...
![第三步： 接受操作员角色](../../../.gitbook/assets/image (20).png)

4. 点击“**发送**”。

![第三步： 接受操作员角色](../../../.gitbook/assets/image (21).png)
...
本系列教程至此结束。如果您想学习如何将 Agent 中的 FIL 提现到交易所，可以参考[此教程](ru-he-jiang-fil-cong-glif-agent-zhuan-chu-zhi-jiao-yi-suo.md)。
