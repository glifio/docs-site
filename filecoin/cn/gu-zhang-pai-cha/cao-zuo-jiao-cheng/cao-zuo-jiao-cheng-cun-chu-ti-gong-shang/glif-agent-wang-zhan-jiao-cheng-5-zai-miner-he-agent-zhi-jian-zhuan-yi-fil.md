...
本教程将带您通过 GLIF 网站界面完成 [**推送资金 (Push)**](glif-agent-wang-zhan-jiao-cheng-5-zai-miner-he-agent-zhi-jian-zhuan-yi-fil.md#cong-agent-xiang-kuang-gong-tui-song-zi-jin) 与 [**提取资金 (Pull)**](glif-agent-wang-zhan-jiao-cheng-5-zai-miner-he-agent-zhi-jian-zhuan-yi-fil.md#cong-kuang-gong-xiang-agent-ti-qu-zi-jin) 操作。
...
![第一步：发起推送资金至矿工](../../../.gitbook/assets/image (27).png)
...
![第一步：发起推送资金至矿工](../../../.gitbook/assets/image (28).png)

5. 点击“**发送**”，并在钱包中批准交易。

![第一步：发起推送资金至矿工](../../../.gitbook/assets/image (29).png)

6. 等待交易完成。完成后，一个“**Push Funds**”提案会出现在“**Agent 拥有者提案**”部分。

![第一步：发起推送资金至矿工](https://2973863842-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6Q2zGcG6QOSRYiiZgFn5%2Fuploads%2FHGl3IKOcGJas9UfEu5Bt%2Fimage.png?alt=media&token=f9c42c38-ef5f-4fd6-861c-d072206e020c)
...
![第二步：审批提案](../../../.gitbook/assets/image (23).png)
...
![第一步：发起从矿工提取资金操作](../../../.gitbook/assets/image (22).png)
...
![第一步：发起从矿工提取资金操作](../../../.gitbook/assets/image (24).png)

5. 点击“**发送**”，并在钱包中批准交易。

![第一步：发起从矿工提取资金操作](../../../.gitbook/assets/image (25).png)

6. 等待交易完成。完成后，一个“**Pull Funds**”提案会出现在“**Agent 拥有者提案**”部分。

![第一步：发起从矿工提取资金操作](https://2973863842-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6Q2zGcG6QOSRYiiZgFn5%2Fuploads%2FdI1ijhkfM2D3gj7NnArf%2Fimage.png?alt=media&token=ca7fc8d6-3cd4-4400-9a5e-ce62420966f1)
...
![第二步：审批提案](../../../.gitbook/assets/image (26).png)
...
在[第六部分](glif-agent-wang-zhan-jiao-cheng-6-ti-qu-jiang-li-yu-zhi-xian-jin.md)中，我们将介绍如何从 Agent 中提取奖励或预支现金。
