...
当您的 Agent 满足借款与清算价值比 (DTL) 要求时即可进行此操作。关于 DTL 的更多信息请参考[文档](../../../cun-chu-ti-gong-shang/jie-kuan-shang-xian-jie-kuan-yu-qing-suan-jia-zhi-bi-dtl.md)。
...
{% hint style="warning" %}
这里会显示可提取的最大金额。该金额取决于您的借款与清算价值比 (DTL) 。详情请参阅相关[文档](../../../cun-chu-ti-gong-shang/jie-kuan-shang-xian-jie-kuan-yu-qing-suan-jia-zhi-bi-dtl.md)。
{% endhint %}

3. 点击“**提取**”。

<div align="left"><figure><img src="../../../.gitbook/assets/image (4).png" alt="" width="402"><figcaption></figcaption></figure></div>
...
<div align="left"><figure><img src="https://2973863842-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6Q2zGcG6QOSRYiiZgFn5%2Fuploads%2FH8xYkaA8gFzL2b8IZoeV%2Fimage.png?alt=media&#x26;token=4c783361-d062-4273-991a-c1893c98f2b4" alt=""><figcaption></figcaption></figure></div>
...
在本系列教程的[第七部分](glif-agent-wang-zhan-jiao-cheng-7-cong-agent-zhong-yi-chu-kuang-gong.md)中，我们将介绍如何从 Agent 中移除矿工。
