...
![第一步：发起提取提案](../../../.gitbook/assets/image (4).png)
...
![第一步：发起提取提案](../../../.gitbook/assets/image (5).png)

5. 点击“**发送**”，并在钱包中批准交易。

![第一步：发起提取提案](../../../.gitbook/assets/image (6).png)

6. 等待交易完成。一个“**Withdraw**”提案会出现在“**Agent 拥有者提案**”部分。

![第一步：发起提取提案](https://2973863842-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F6Q2zGcG6QOSRYiiZgFn5%2Fuploads%2FH8xYkaA8gFzL2b8IZoeV%2Fimage.png?alt=media&#x26;token=4c783361-d062-4273-991a-c1893c98f2b4)
...
![第二步: 审批提案](../../../.gitbook/assets/image (1).png)
