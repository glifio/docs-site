...
![在GLIF网站上创建您的 Ag](../../../.gitbook/assets/image (269).png)

如果您只想使用 2 个签名人，可在拥有者设置中将“**所需批准**”修改为 2，并删除“**签名者 3**”。

![在GLIF网站上创建您的 Ag](../../../.gitbook/assets/image (270).png)

点击“**创建拥有者**”后，您需要在 MetaMask 中批准这笔交易：

![MetaMask prompt](../../../.gitbook/assets/image (271).png)
...
![在GLIF网站上创建您的 Ag](../../../.gitbook/assets/image (272).png)

当多签钱包创建交易确认后，您就可以点击“**创建 Agent**”按钮，并在 MetaMask 中批准该交易：

![MetaMask prompt](../../../.gitbook/assets/image (273).png)

***

第 5 步 — 等待 Agent 创建交易确认

![在GLIF网站上创建您的 Ag](../../../.gitbook/assets/image (274).png)

***

第 6 步 — 成功！您将看到一个新创建的 Agent。

![在GLIF网站上创建您的 Ag](../../../.gitbook/assets/image (275).png)
