...
![第一步：发起借款多签提案](cn-glif-agent-wang-zhan-jiao-cheng-4-jie-kuan_1.png)
...
![第一步：发起借款多签提案](cn-glif-agent-wang-zhan-jiao-cheng-4-jie-kuan_2.png)
...
![第二步：审批提案](cn-glif-agent-wang-zhan-jiao-cheng-4-jie-kuan_3.png)

4. 在钱包中确认交易。
5. 等待交易完成（通常需要几分钟）。批准后，Agent 页面中的可用余额将更新。

![第二步：审批提案](cn-glif-agent-wang-zhan-jiao-cheng-4-jie-kuan_4.png)
