...
[清算价值](../../../cun-chu-ti-gong-shang/sp-qing-suan-jia-zhi.md)是如果矿工的扇区被终止，在減去罚金和其他损失后，存储提供商的Miner Actor可以收回的預计价值。其计算方式为：
...
要确定您还能从 GLIF 借多少，您需要了解 [**借款与清算价值比** (**DTL)**](../../../cun-chu-ti-gong-shang/jie-kuan-shang-xian-jie-kuan-yu-qing-suan-jia-zhi-bi-dtl.md)。DTL 比率必须低于 75%。详情请阅读[这里](../../../cun-chu-ti-gong-shang/jie-kuan-shang-xian-jie-kuan-yu-qing-suan-jia-zhi-bi-dtl.md)。
...
（有关借入FIL 的更多用途，请点击[此处](../../../cun-chu-ti-gong-shang/jie-ru-fil-yong-tu.md)了解详情。）
