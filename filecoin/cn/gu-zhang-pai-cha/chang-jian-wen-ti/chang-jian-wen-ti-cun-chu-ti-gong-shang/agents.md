...
有关详细信息，请参阅[此处](../../../cun-chu-ti-gong-shang/shi-yong-agents-guan-li-jie-dian.md)。

## 节点担保制度如何运作？

[节点担保制度](../../../cun-chu-ti-gong-shang/jie-dian-dan-bao-zhi-du.md)允许存储提供商 (SP)  使用更大、更有价值的Miner Actor作为抵押品，以支持其他Miner Actor的借款。换句话说，用作抵押品的Miner Actor不一定也必须是用于封装的Miner Actor。
...
如果有任何问题，请在 [Discord](https://discord.gg/5qsJjsP3Re) 上提交客服單 (support-ticket channel)。
