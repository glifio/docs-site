...
当 SP 借入 FIL 是用于存储挖矿时，它可以从 GLIF 借入更多 FIL，因为借入的 FIL 包含在 SP 的[清算价值](sp-qing-suan-jia-zhi.md)中。因此，SP 受 [借款与清算价值比 (DTL) ](jie-kuan-shang-xian-jie-kuan-yu-qing-suan-jia-zhi-bi-dtl.md)比率的限制较少，因为 SP 的清算价值与其债务同时增长。
