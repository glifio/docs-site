---
description: Benefits at a Glance for Storage Providers
---
...
Active GLIF+ cardholders receive higher borrowing limits, up to 10× leverage. See the [Tier Table](tiers-and-limits.md) for exact limits per status.
...
Once funded, up to 10% of every interest payment can be redeemed with your $GLF. The protocol swaps your $GLF into FIL at a premium determined by your tier—up to +25% for Gold members. See the [Tier Table](tiers-and-limits.md) for details.
