...
* GLIF issues [stICNT](reward-mechanism-sticnt.md) tokens back to depositors, allowing them to get immediate liquidity on their tokens by swapping [stICNT](reward-mechanism-sticnt.md) for ICNT through GLIF at any time. See [Unstaking](unstaking.md).
* As staking rewards accrue, the value of $stICNT increases, so 1 stICNT will be worth more ICNT over time. See [Reward Mechanism - stICNT](reward-mechanism-sticnt.md) for more details.
