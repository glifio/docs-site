...
* has undergone professional security audits
...
At the time of writing this documentation, slashing has not yet been implemented or enforced on the underlying ICN Protocol. As a result, slashing risk is not yet a concern, however, the protocol will be setup to monitor for slashing risk once slashing is turned on. Slashing mitigation techniques will be implemented once the slashing mechanism is more well known.
