...
Liquidity can be provided by depositing FIL into GLIF on the pool page [here](https://www.glif.io/en/pool/infinity). In exchange for your deposit, you'll receive a proportionate amount of [iFIL](/docs/for-liquidity-providers/glif-reward-mechanism-ifil) tokens at the current iFIL price.
