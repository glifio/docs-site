...
In [Part 9](/docs/7-troubleshooting/2-tutorials/2-for-storage-providers/9-glif-agent-website-tutorial-part-9-change-operator-address) of this tutorial, we will show you how to change your operator address.
