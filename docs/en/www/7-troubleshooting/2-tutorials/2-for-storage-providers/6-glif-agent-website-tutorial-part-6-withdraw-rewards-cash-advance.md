...
4. Borrowing FIL from GLIF ([Part 4](/docs/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-4-borrow))
5. Moving FIL from Miner to Agent and back ([Part 5](/docs/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-5-moving-fil-between-miner-and-agent))
...
You can do this when you meet the DTL requirement on your Agent - to read more about the DTL, see our [docs](/docs/for-storage-providers/borrowing-limits-and-dtl).
...
> [!WARNING]
> The maximum withdrawal amount is displayed here and depends on your DTL. See [docs](/docs/for-storage-providers/borrowing-limits-and-dtl) for details.

3. Click “**Withdraw**.”

![Withdraw button](en-image-249.png "500")
