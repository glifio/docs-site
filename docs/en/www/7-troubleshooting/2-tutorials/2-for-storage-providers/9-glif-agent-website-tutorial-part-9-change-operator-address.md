...
6. Withdrawing rewards / cash advance ([Part 6](/docs/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-6-withdraw-rewards-cash-advance))
7. Removing a miner from an Agent ([Part 7](/docs/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-7-remove-a-miner-from-an-agent))
8. Make a payment to GLIF ([Part 8](/docs/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-8-payment))
