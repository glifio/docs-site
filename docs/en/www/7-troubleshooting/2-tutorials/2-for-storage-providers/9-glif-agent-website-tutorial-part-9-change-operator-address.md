...
7. Removing a miner from an Agent ([Part 7](/docs/7-troubleshooting/2-tutorials/2-for-storage-providers/7-glif-agent-website-tutorial-part-7-remove-a-miner-from-an-agent))
8. Make a payment to GLIF ([Part 8](/docs/7-troubleshooting/2-tutorials/2-for-storage-providers/8-glif-agent-website-tutorial-part-8-payment))
...
This is the end of this tutorial series. If you would like to learn how to withdraw FIL from the Agent to an exchange, check out this [tutorial](/docs/7-troubleshooting/2-tutorials/2-for-storage-providers/10-how-to-withdraw-fil-from-the-agent-to-an-exchange-at-glif).
