...
Please refer to [Part 3](/7-troubleshooting/2-tutorials/2-for-storage-providers/3-glif-agent-website-tutorial-part-3-add-your-miner) of this tutorial series for steps to add a miner to your Agent. Miner's balance can be used as collateral.
...
See the [docs](/3-for-storage-providers/3-borrowing-limits-and-dtl) here for details.
...
In [Part 5](/7-troubleshooting/2-tutorials/2-for-storage-providers/5-glif-agent-website-tutorial-part-5-moving-fil-between-miner-and-agent) of this tutorial, we will show you how to move FIL from Miner to Agent and back.
