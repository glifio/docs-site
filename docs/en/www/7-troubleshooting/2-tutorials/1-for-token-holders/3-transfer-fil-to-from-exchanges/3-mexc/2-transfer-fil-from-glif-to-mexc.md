...
* This is because some exchanges, including MEXC, do not support deposit from `f410` or `0x` addresses. Check this [page](/docs/troubleshooting/tutorials/for-token-holders/transfer-fil-to-from-exchanges/transfer-fil-between-exchange-and-glif) for more details.
