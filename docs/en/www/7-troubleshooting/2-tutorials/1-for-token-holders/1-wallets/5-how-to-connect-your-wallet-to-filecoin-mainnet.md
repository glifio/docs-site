...
GLIF is compatible with [most EVM wallets](https://filecointldr.io/how-to-buy-filecoin) as well as the [FilSnap (MetaMask snap](/7-troubleshooting/2-tutorials/1-for-token-holders/1-wallets/4-how-to-obtain-a-filsnap-wallet-as-the-intermediary-wallet)[)](/7-troubleshooting/2-tutorials/1-for-token-holders/1-wallets/4-how-to-obtain-a-filsnap-wallet-as-the-intermediary-wallet) and the [Ledger in Filecoin App](/7-troubleshooting/2-tutorials/1-for-token-holders/1-wallets/2-how-to-obtain-a-ledger-wallet-as-the-intermediary-wallet). You can find more information about Filecoin wallets [here](https://filecointldr.io/how-to-buy-filecoin). Make sure to do your own research (DYOR) to select the wallet.
...
> [!TIP]
> Using Ledger? Check out our Ledger tutorial [here](/7-troubleshooting/2-tutorials/1-for-token-holders/2-using-the-pool/2-how-to-deposit-filecoin-from-a-hardware-wallet-with-glif).
