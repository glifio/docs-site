...
To deposit FIL to GLIF, you first need to choose a wallet that supports FIL. GLIF is compatible with [most EVM wallets](https://filecointldr.io/how-to-buy-filecoin). You can find more tutorials about wallets [here](/docs/troubleshooting/tutorials/for-token-holders/wallets). Make sure to do your own research (DYOR) to select the wallet.
...
For detailed instructions on add the Filecoin Mainnet to your wallet, check out this [tutorial](/docs/troubleshooting/tutorials/for-token-holders/wallets/how-to-connect-your-wallet-to-filecoin-mainnet).
...
> [!NOTE]
> For more information on iFIL, check out our [docs](/docs/for-liquidity-providers/glif-reward-mechanism-ifil).
...
When you are ready to withdraw your deposit, you will need to return your iFIL to GLIF to receive your FIL back. For more details about the withdrawal process, check [here](/docs/for-liquidity-providers/exit-withdraw-fil).
