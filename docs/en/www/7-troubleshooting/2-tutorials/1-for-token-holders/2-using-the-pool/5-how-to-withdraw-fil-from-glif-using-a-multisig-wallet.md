...
In this tutorial, a GLIF multisig wallet with deposited FIL, holding iFIL, is created. If you have not set one up yet, refer to our [previous tutorial](/7-troubleshooting/2-tutorials/1-for-token-holders/2-using-the-pool/3-how-to-deposit-fil-to-glif-using-multisig-wallet) on creating a multisig wallet and depositing FIL.
...
If you want to learn how to **deposit** from the GLIF pool using a multisig wallet, refer to our previous tutorial [here](/7-troubleshooting/2-tutorials/1-for-token-holders/2-using-the-pool/3-how-to-deposit-fil-to-glif-using-multisig-wallet).
