...
The Miner Actor that serves as the collateral node does not need to be the Miner Actor that ends up receiving borrowed funds. See more information about aggregating borrowing power under the [Agents](/docs/3-for-storage-providers/7-manage-miner-actors-with-agents) section.
