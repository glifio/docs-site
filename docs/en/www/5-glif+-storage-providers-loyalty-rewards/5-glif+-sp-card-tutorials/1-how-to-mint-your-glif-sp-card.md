...
This tutorial explains how to mint a GLIF+ Storage Provider Card on the GLIF website using your Agent's multisig wallet. For more information about the different [tiers](/docs/glif-storage-providers-loyalty-rewards/tiers-and-limits) and how GLIF+ Cards benefit you, see [this page](/docs/glif-storage-providers-loyalty-rewards/benefits-for-storage-providers).
