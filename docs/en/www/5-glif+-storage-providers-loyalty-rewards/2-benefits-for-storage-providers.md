...
Active GLIF+ cardholders receive higher borrowing limits, up to 10× leverage. See the [Tier Table](/docs/glif-storage-providers-loyalty-rewards/tiers-and-limits) for exact limits per status.
...
2. You hold an active GLIF+ Loyalty Card (see activation steps in [next section](/docs/glif-storage-providers-loyalty-rewards/how-to-join-glif-sp-program)).
