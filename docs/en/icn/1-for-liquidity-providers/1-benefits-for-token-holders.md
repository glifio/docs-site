...
* GLIF issues [stICNT](/docs/1-for-liquidity-providers/2-reward-mechanism-sticnt) tokens back to depositors, allowing them to get immediate liquidity on their tokens by swapping [stICNT](/docs/1-for-liquidity-providers/2-reward-mechanism-sticnt) for ICNT through GLIF at any time. See [Unstaking](/docs/1-for-liquidity-providers/3-unstaking).
* As staking rewards accrue, the value of $stICNT increases, so 1 stICNT will be worth more ICNT over time. See [Reward Mechanism - stICNT](/docs/1-for-liquidity-providers/2-reward-mechanism-sticnt) for more details.
