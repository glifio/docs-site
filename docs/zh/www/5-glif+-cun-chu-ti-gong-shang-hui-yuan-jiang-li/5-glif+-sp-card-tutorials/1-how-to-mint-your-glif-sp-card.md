...
本教程介绍如何在 GLIF 网站上使用您的 Agent 多签钱包铸造 GLIF+ 存储提供商会员卡。有关不同[等级](/docs/glif-cun-chu-ti-gong-shang-hui-yuan-jiang-li/deng-ji-yu-xian-zhi)以及GLIF+ 会员卡如何使您受益，请参阅[此页面](/docs/glif-cun-chu-ti-gong-shang-hui-yuan-jiang-li/cun-chu-ti-gong-shang-quan-yi)。

有关管理您的 GLIF+ SP 会员卡的其他教程，请参阅[此页面](/docs/glif-cun-chu-ti-gong-shang-hui-yuan-jiang-li/glif-sp-card-tutorials)。
...
> [!NOTE]
> 更高等级提供更强大的福利，例如更高的 TWAP 兑换率和更高的借贷杠杆。例如，金卡等级的最高债务与清算比率 (DTL)为 90%。有关 TWAP 兑换率或最高DTL杠杆等术语的解释，请参阅[此页面](/docs/glif-cun-chu-ti-gong-shang-hui-yuan-jiang-li/deng-ji-yu-xian-zhi)。
...
您可以查看其他[教程](/docs/glif-cun-chu-ti-gong-shang-hui-yuan-jiang-li/glif-sp-card-tutorials)，了解更多如何管理您的 GLIF+ SP 会员卡。
