...
> [!NOTE]
> 请[点击此处](/docs/liu-dong-xing-ti-gong-zhe/ti-qu-fil)，了解更多关于提取机制。
...
1. 在 “**池**” 页面中，点击 “**取款**” 选项。
2. 输入您想要赎回的 iFIL 数量，将会显示相应可获得的 FIL 数量。请[点击此处](/docs/liu-dong-xing-ti-gong-zhe/glif-jiang-li-ji-zhi-ifil)了解更多关于 iFIL 的信息。
3. 点击 “**批准**”。
