...
1. 连接您在[第二部分](/docs/7-gu-zhang-pai-cha/2-cao-zuo-jiao-cheng/2-cao-zuo-jiao-cheng-cun-chu-ti-gong-shang/2-glif-agent-wang-zhan-jiao-cheng-2-chuang-jian-nin-de-agent)中创建的多签钱包的其中一个签名钱包。
...
1. 使用其他签名钱包登录。您可以在多签页面的“**所需批准**”部分找到所有签名钱包。这些钱包应与[第二部分](/docs/7-gu-zhang-pai-cha/2-cao-zuo-jiao-cheng/2-cao-zuo-jiao-cheng-cun-chu-ti-gong-shang/2-glif-agent-wang-zhan-jiao-cheng-2-chuang-jian-nin-de-agent)中所使用的相同。
...
在本系列教程的[第四部分](/docs/7-gu-zhang-pai-cha/2-cao-zuo-jiao-cheng/2-cao-zuo-jiao-cheng-cun-chu-ti-gong-shang/4-glif-agent-wang-zhan-jiao-cheng-4-jie-kuan)中，我们将向您展示如何借取FIL。
