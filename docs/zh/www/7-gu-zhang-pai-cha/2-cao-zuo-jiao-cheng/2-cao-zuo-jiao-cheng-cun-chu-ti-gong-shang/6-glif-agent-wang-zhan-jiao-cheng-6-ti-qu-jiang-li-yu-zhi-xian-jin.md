...
当您的 Agent 满足借款与清算价值比 (DTL) 要求时即可进行此操作。关于 DTL 的更多信息请参考[文档](/docs/3-cun-chu-ti-gong-shang/3-jie-kuan-shang-xian-jie-kuan-yu-qing-suan-jia-zhi-bi-dtl)。
...
> [!WARNING]
> 这里会显示可提取的最大金额。该金额取决于您的借款与清算价值比 (DTL) 。详情请参阅相关[文档](/docs/3-cun-chu-ti-gong-shang/3-jie-kuan-shang-xian-jie-kuan-yu-qing-suan-jia-zhi-bi-dtl)。
...
在本系列教程的[第七部分](/docs/7-gu-zhang-pai-cha/2-cao-zuo-jiao-cheng/2-cao-zuo-jiao-cheng-cun-chu-ti-gong-shang/7-glif-agent-wang-zhan-jiao-cheng-7-cong-agent-zhong-yi-chu-kuang-gong)中，我们将介绍如何从 Agent 中移除矿工。
