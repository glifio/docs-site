...
有关详细信息，请参阅[此处](/docs/1-jie-shao)。

## 作为 FIL 代币持有者，我可以使用 GLIF 做什么？

作为 FIL 代币持有者，您可以通过以下几种方式使用 GLIF：

1. 使用我们内置的钱包或多签功能 - GLIF 的[钱包](/wallet)和[多签](/multisig)在整个Filecoin生态系统中被广泛使用，支援发送/接收/托管 FIL。
2. 将 FIL 存入 GLIF 以赚取奖励。有关详细信息，请参阅[此处](/docs/2-liu-dong-xing-ti-gong-zhe/2-glif-jiang-li-ji-zhi-ifil)。
