...
流动性提供者（Liquidity Providers，简称 LP）是将 FIL 存入 GLIF 以赚取奖励的 FIL 持有者。LP 在存入 FIL 时会收到 iFIL 代币，并通过持有 [iFIL](/docs/2-liu-dong-xing-ti-gong-zhe/2-glif-jiang-li-ji-zhi-ifil) 代币以赚取奖励。LP 的奖励来自于从 GLIF 借入 FIL 的存储提供商所支付的费用。随着 GLIF 从存储提供商那里累积更多费用，iFIL 的价值会随着时间的推移而增加。
