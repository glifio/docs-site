...
本教程专门针对从 MEXC 转移 FIL。请[点击此处](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-liu-dong-xing-ti-gong-zhe/jiang-fil-zhuan-ru-huo-zhuan-chu-jiao-yi-suo)查看其他交易所的教程。

> [!NOTE]
> GLIF 与大多数 EVM 钱包兼容。本教程以 MetaMask 钱包为示例，其他钱包同样适用。\
> 您可以参考我们的[常见问题](/gu-zhang-pai-cha/chang-jian-wen-ti/chang-jian-wen-ti-liu-dong-xing-ti-gong-zhe)和[钱包教程](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-liu-dong-xing-ti-gong-zhe/qian-bao)以获取更多资讯。
>
...
* 您需要使用中介钱包，例如 [FilSnap 钱包](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-liu-dong-xing-ti-gong-zhe/qian-bao/ru-he-li-yong-filsnap-qian-bao-zuo-wei-zhong-jie-qian-bao)、[Burner钱包](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-liu-dong-xing-ti-gong-zhe/qian-bao/ru-he-li-yong-burner-qian-bao-zuo-wei-zhong-jie-qian-bao)或 [Ledger](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-liu-dong-xing-ti-gong-zhe/qian-bao/ru-he-li-yong-ledger-qian-bao-zuo-wei-zhong-jie-qian-bao)。点击链结查看创建不同中介钱包的教程。
* 这是因为一些交易所，包括 MEXC，还不支持转移到 `f410` 或 `0x` 地址。请[点击此处](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-liu-dong-xing-ti-gong-zhe/jiang-fil-zhuan-ru-huo-zhuan-chu-jiao-yi-suo/zai-jiao-yi-suo-he-glif-zhi-jian-zhuan-yi-fil)查看详细解释。

完成后，中介钱包的地址（以 `f1` 开头）将显示在右上角的下拉菜单。复制此地址。

![步骤 1：设置中介钱包（如有需](cn-image-242.webp)

## 步骤 2：将 Filecoin 从交易所发送到中介钱包

1. 前往您使用的中心化交易所（MEXC），在您的资产列表中找到 FIL。点击 “提币”。

![步骤 2：将 Filecoin](cn-image-245.webp)
...
![步骤 2：将 Filecoin](cn-image-246.webp)
...
![步骤 3：检查中介钱包中的 F](cn-image-249.webp)

2. 在 “Account” 标签下检查您的 FIL 余额，并在 “Transaction” 标签下查看交易详情。

![步骤 3：检查中介钱包中的 F](cn-image-248.webp)
...
如需详细了解如何将钱包连接到 Filecoin 主网，请[查看此教程](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-liu-dong-xing-ti-gong-zhe/qian-bao/ru-he-jiang-qian-bao-lian-jie-dao-filecoin-zhu-wang)。
...
![步骤 5：将 Filecoin](cn-image-252.webp)
...
![步骤 5：将 Filecoin](cn-image-253.webp)

稍等片刻，您的 Filecoin 余额将出现在您的主钱包中！

## 步骤 6：在GLIF 存入您的 Filecoin

现在，您可以直接从交易所将FIL存入 GLIF 并开始赚取收益！有关存款的详细操作，请查看[此教程](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-liu-dong-xing-ti-gong-zhe/shi-yong-glif-chi-cun-ru-he-ti-qu/jiang-fil-cun-ru-glif-yi-zhuan-qu-jiang-li)。
