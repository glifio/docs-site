...
本教程将带您将 iFIL 代币从 GLIF 提现到交易所。本教程专门针对将 FIL 转移到 MEXC。请[点击此处](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-liu-dong-xing-ti-gong-zhe/jiang-fil-zhuan-ru-huo-zhuan-chu-jiao-yi-suo/zai-jiao-yi-suo-he-glif-zhi-jian-zhuan-yi-fil)查看其他交易所的教程。
...
2. 要将您的 iFIL 从 GLIF 池中转换为 FIL，请查看[此教程](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-liu-dong-xing-ti-gong-zhe/shi-yong-glif-chi-cun-ru-he-ti-qu/cong-glif-ti-qu-fil)。
3. 提取 FIL 后，您将在钱包中收到 FIL。点击 GLIF 左上方的“钱包”标签，您将能够在 “Account” 部分查看 FIL 和 iFIL 的余额。

![步骤 1：从 GLIF 提取](cn-image-229.webp)
...
![步骤 2：设置中介钱包（如有需](cn-image-242.webp)
...
![MetaMask prompt](cn-image-256.webp)
...
![步骤 3：将 FIL 从](cn-image-260.webp)
...
![步骤 4：在交易所中找到您的接](cn-image-240.webp)

2. 复制交易所提供的 `f1` 地址。

![步骤 4：在交易所中找到您的接](cn-image-261.webp)
