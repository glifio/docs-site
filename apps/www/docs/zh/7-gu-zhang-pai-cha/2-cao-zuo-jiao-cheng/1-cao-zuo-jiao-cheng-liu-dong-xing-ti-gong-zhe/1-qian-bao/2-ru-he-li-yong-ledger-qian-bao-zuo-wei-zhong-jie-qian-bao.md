...
本教程解释了如何使用带有f1地址的Ledger作为中介钱包，可以用作中转点，将FIL从主钱包转移到最终目的地。除了Ledger钱包，您还可以选择使用[Burner钱包](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-liu-dong-xing-ti-gong-zhe/qian-bao/ru-he-li-yong-burner-qian-bao-zuo-wei-zhong-jie-qian-bao)或[FilSnap钱包](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-liu-dong-xing-ti-gong-zhe/qian-bao/ru-he-li-yong-filsnap-qian-bao-zuo-wei-zhong-jie-qian-bao)作为中介钱包。
...
![步骤1. 将硬件钱包连接到电脑](en-image-97.webp)

## 步骤2. 将您的钱包连接到GLIF

1. 访问[GLIF网站](https://www.glif.io/zh)，点击屏幕右上角的“**连接钱包**”。您将看到可连接的钱包列表，选择“**Ledger（Filecoin）**”。

![步骤2. 将您的钱包连接到GLIF](cn-image-36.webp)

2. 如果您的硬件钱包已解锁并连接，浏览器会弹出一个窗口，询问是否连接HID设备。

![步骤2. 将您的钱包连接到GL](en-image-100.webp)
...
![步骤2. 将您的钱包连接到GL](en-image-103.webp)

5. 连接后，将在GLIF网站的右上角看到您的硬件钱包Filecoin地址，以及 FIL总余额。
6. 复制 f1 地址备用。这将是您的第一个Ledger地址。

![步骤2. 将您的钱包连接到GL](cn-image-37.webp)

## 步骤3：生成第二个地址（如有需要）

1. 如果您需要生成第二个地址，点击左上角选择栏的“钱包”。

![步骤3：生成第二个地址（如有需](cn-image-40.webp)

2. 点击屏幕左侧的“添加账户”，复制第二个地址备用。

![步骤3：生成第二个地址（如有需](cn-image-39.webp)

## 结论

使用带有f1地址的 Ledger 作为中介钱包是很快速的过程，并让您的交易顺利进行。

请记住保管好钱包助记词，并在发送大量资金之前进行小额测试！
