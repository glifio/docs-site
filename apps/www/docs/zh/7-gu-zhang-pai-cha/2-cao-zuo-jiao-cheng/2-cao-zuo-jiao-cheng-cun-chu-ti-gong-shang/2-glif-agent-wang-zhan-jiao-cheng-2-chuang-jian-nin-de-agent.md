...
_如果您还不熟悉 GLIF Agent 的基础知识以及在 GLIF 网站上创建 Agent 的准备步骤，建议您先阅读本教程的_[_第一部分_](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-cun-chu-ti-gong-shang/glif-agent-wang-zhan-jiao-cheng-1-zhun-bei-she-zhi)_。_
...
> [!TIP]
> 如果您的钱包余额为零，请使用“存款”按钮从其他钱包向该钱包地址进行转账，或从交易所向该钱包地址充币。如果遇到存入资金的问题，请参阅此处的[教程](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-liu-dong-xing-ti-gong-zhe/jiang-fil-zhuan-ru-huo-zhuan-chu-jiao-yi-suo/zai-jiao-yi-suo-he-glif-zhi-jian-zhuan-yi-fil)。
...
在本教程的[第三部分](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-cun-chu-ti-gong-shang/glif-agent-wang-zhan-jiao-cheng-3-tian-jia-nin-de-kuang-gong)，我们将向您展示如何将 Filecoin 矿工添加到您的 Agent 中。
