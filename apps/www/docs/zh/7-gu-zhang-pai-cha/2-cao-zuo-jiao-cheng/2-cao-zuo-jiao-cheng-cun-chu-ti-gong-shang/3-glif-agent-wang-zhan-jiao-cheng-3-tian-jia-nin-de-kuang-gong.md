...
1. 连接您在[第二部分](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-cun-chu-ti-gong-shang/glif-agent-wang-zhan-jiao-cheng-2-chuang-jian-nin-de-agent)中创建的多签钱包的其中一个签名钱包。
...
在本系列教程的[第四部分](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-cun-chu-ti-gong-shang/glif-agent-wang-zhan-jiao-cheng-4-jie-kuan)中，我们将向您展示如何借取FIL。
