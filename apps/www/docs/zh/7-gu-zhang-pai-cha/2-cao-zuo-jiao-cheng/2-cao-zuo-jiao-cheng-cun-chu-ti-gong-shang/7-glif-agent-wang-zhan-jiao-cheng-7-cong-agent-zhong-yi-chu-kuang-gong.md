...
![第一步 发起移除矿工提案](cn-image-9.webp)

5. 点击“**发送**”，并在钱包中批准交易。

![第一步 发起移除矿工提案](cn-image-10.webp)

5. 等待交易完成。一个“**RemoveMiner**”提案将出现在“**Agent 拥有者提案**”部分。

![第一步 发起移除矿工提案](cn-image-12.webp)
...
![第二步: 审批提案](cn-image-7.webp)

4. 在钱包中确认交易。
5. 等待交易完成（约 1–2 分钟）。完成后，该矿工将从您的 Agent 中移除。

![第二步: 审批提案](cn-image-11.webp)
...
在本系列教程的[第八部分](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-cun-chu-ti-gong-shang/glif-agent-wang-zhan-jiao-cheng-8-fu-kuan)中，我们将介绍如何向 GLIF 进行付款。
