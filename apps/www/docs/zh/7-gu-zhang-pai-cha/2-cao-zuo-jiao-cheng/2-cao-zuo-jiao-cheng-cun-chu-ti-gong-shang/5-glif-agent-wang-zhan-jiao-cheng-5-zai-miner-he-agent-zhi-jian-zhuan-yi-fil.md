...
![第一步：发起推送资金至矿工](cn-image-27.webp)
...
![第一步：发起推送资金至矿工](cn-image-28.webp)

5. 点击“**发送**”，并在钱包中批准交易。

![第一步：发起推送资金至矿工](cn-image-29.webp)

6. 等待交易完成。完成后，一个“**Push Funds**”提案会出现在“**Agent 拥有者提案**”部分。

![第一步：发起推送资金至矿工](en-image-233.webp)
...
![第一步：发起从矿工提取资金操作](cn-image-22.webp)
...
![第一步：发起从矿工提取资金操作](cn-image-24.webp)

5. 点击“**发送**”，并在钱包中批准交易。

![第一步：发起从矿工提取资金操作](cn-image-25.webp)

6. 等待交易完成。完成后，一个“**Pull Funds**”提案会出现在“**Agent 拥有者提案**”部分。

![第一步：发起从矿工提取资金操作](en-image-240.webp)
...
在[第六部分](/gu-zhang-pai-cha/cao-zuo-jiao-cheng/cao-zuo-jiao-cheng-cun-chu-ti-gong-shang/glif-agent-wang-zhan-jiao-cheng-6-ti-qu-jiang-li-yu-zhi-xian-jin)中，我们将介绍如何从 Agent 中提取奖励或预支现金。
