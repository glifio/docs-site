...
To use applications on the FVM, you may need to have FIL inside an `f410` or `0x` type address. Any `f410` wallet address also has an equivalent `0x` Ethereum-style address, so you can convert any `f410` address into a `0x` address, and vice versa. Check out this [tutorial](/troubleshooting/tutorials/for-token-holders/wallets/how-to-find-your-corresponding-0x-f410-wallet-address) for instructions on how to convert `0x` and `f410` wallet addresses.
...
* Binance:
  * [Transfer FIL from Binance to GLIF](/troubleshooting/tutorials/for-token-holders/transfer-fil-to-from-exchanges/binance/transfer-fil-from-binance-to-glif)
  * [Transfer FIL from GLIF to Binance](/troubleshooting/tutorials/for-token-holders/transfer-fil-to-from-exchanges/binance/transfer-fil-from-glif-to-binance)
* MEXC:
  * [Transfer FIL from MEXC to GLIF](/troubleshooting/tutorials/for-token-holders/transfer-fil-to-from-exchanges/mexc/transfer-fil-from-mexc-to-glif)
  * [Transfer FIL from GLIF to MEXC](/troubleshooting/tutorials/for-token-holders/transfer-fil-to-from-exchanges/mexc/transfer-fil-from-glif-to-mexc)
...
Now, you can deposit your tokens directly from your exchange to GLIF and start earning rewards! Check the [step-by-step guide](/troubleshooting/tutorials/for-token-holders/using-the-pool/deposit-fil-into-glif-to-earn-rewards) in this tutorial for detailed deposit instructions.
