...
This tutorial will guide you through the process of withdraw your iFIL tokens from GLIF to an exchange.  This tutorial is specifically for transferring FIL to MEXC. Check this [page](/troubleshooting/tutorials/for-token-holders/transfer-fil-to-from-exchanges/transfer-fil-between-exchange-and-glif) for tutorials on other exchanges.
...
2. To transfer your iFIL from the GLIF pool to FIL, follow the [step-by-step guide](/troubleshooting/tutorials/for-token-holders/using-the-pool/withdraw-fil-from-glif) in this tutorial.
...
![Token balances](en-image-60.webp)
...
* This is because some exchanges, including MEXC, do not support deposit from `f410` or `0x` addresses. Check this [page](/troubleshooting/tutorials/for-token-holders/transfer-fil-to-from-exchanges/transfer-fil-between-exchange-and-glif) for more details.
...
![MetaMask prompt](en-image-86.webp)
...
![Wallet confirmation](en-image-94.webp)
