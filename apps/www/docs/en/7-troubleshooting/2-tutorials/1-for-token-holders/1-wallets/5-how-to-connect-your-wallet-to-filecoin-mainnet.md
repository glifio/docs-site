...
GLIF is compatible with [most EVM wallets](https://filecointldr.io/how-to-buy-filecoin) as well as the [FilSnap (MetaMask snap](/troubleshooting/tutorials/for-token-holders/wallets/how-to-obtain-a-filsnap-wallet-as-the-intermediary-wallet)[)](/troubleshooting/tutorials/for-token-holders/wallets/how-to-obtain-a-filsnap-wallet-as-the-intermediary-wallet) and the [Ledger in Filecoin App](/troubleshooting/tutorials/for-token-holders/wallets/how-to-obtain-a-ledger-wallet-as-the-intermediary-wallet). You can find more information about Filecoin wallets [here](https://filecointldr.io/how-to-buy-filecoin). Make sure to do your own research (DYOR) to select the wallet.
...
> [!TIP]
> Using Ledger? Check out our Ledger tutorial [here](/troubleshooting/tutorials/for-token-holders/using-the-pool/how-to-deposit-filecoin-from-a-hardware-wallet-with-glif).

2. Click “**Confirm**”, then click “**Approve**” in MetaMask.

![Confirm button](en-image-159.webp)
...
![Connect wallet](en-image-40.webp)
