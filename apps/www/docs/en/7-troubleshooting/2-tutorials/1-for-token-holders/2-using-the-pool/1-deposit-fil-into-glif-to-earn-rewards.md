...
To deposit FIL to GLIF, you first need to choose a wallet that supports FIL. GLIF is compatible with [most EVM wallets](https://filecointldr.io/how-to-buy-filecoin). You can find more tutorials about wallets [here](/troubleshooting/tutorials/for-token-holders/wallets). Make sure to do your own research (DYOR) to select the wallet.

In this tutorial we will use MetaMask, but you can find a similar tutorial using Ledger [here](/troubleshooting/tutorials/for-token-holders/using-the-pool/how-to-deposit-filecoin-from-a-hardware-wallet-with-glif).
...
![GLIF connect button](en-image-156.webp)

2. Select the wallet you wish to connect with that is funded with FIL.

![Wallet selection](en-image-158.webp)
...
For detailed instructions on add the Filecoin Mainnet to your wallet, check out this [tutorial](/troubleshooting/tutorials/for-token-holders/wallets/how-to-connect-your-wallet-to-filecoin-mainnet).
...
![Deposit page](en-image-171.webp)

3. Enter the amount you wish to deposit, and click “**Deposit**”.

![Amount input](en-image-173.webp)

4. Then hit “**Send**”.

![Send confirmation](en-image-382.webp)
...
![Wallet confirmation](en-image-176.webp)
...
> [!NOTE]
> For more information on iFIL, check out our [docs](/for-liquidity-providers/glif-reward-mechanism-ifil).
...
![Position view](en-image-38.webp)
...
![Add token dialog](en-image-175.webp)

2. Click “**Add token**” in MetaMask.

![Add token dialog](en-image-209.webp)

## Conclusion

Congratulations on successfully depositing FIL to GLIF!

When you are ready to withdraw your deposit, you will need to return your iFIL to GLIF to receive your FIL back. For more details about the withdrawal process, check [here](/for-liquidity-providers/exit-withdraw-fil).
