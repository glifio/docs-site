...
Refer to [this tutorial](/troubleshooting/tutorials/for-token-holders/wallets/how-to-create-a-multisig-wallet-on-glif) for detailed **instructions** on creating a multisig wallet.
...
![Approve proposal](en-image-297.webp)
...
![Toggle button](en-image-298.webp)
...
> [!NOTE]
> The FIL to iFIL ratio may not be 1:1 due to price fluctuations. Refer to this section of the [docs](/for-liquidity-providers/glif-reward-mechanism-ifil) for more details on iFIL calculations.

![Deposit FIL](en-image-336.webp)
...
![Transaction confirmation](en-image-340.webp)
...
![Create multisig](en-image-39.webp)
...
![Approve proposal](en-image-338.webp)
...
![Approve proposal](en-image-339.webp)
...
![Approve proposal](en-image-275.webp)
...
![Approve proposal](en-image-276.webp)
...
If you want to learn how to **withdraw** from the GLIF pool after making a deposit, refer to our next tutorial [here](/troubleshooting/tutorials/for-token-holders/using-the-pool/how-to-withdraw-fil-from-glif-using-a-multisig-wallet).
