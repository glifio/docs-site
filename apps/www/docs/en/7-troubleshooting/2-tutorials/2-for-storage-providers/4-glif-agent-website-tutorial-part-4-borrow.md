...
![Copy address](en-image-213.webp)

#### 2. Available Balance in a Miner Added to the Agent

Please refer to [Part 3](/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-3-add-your-miner) of this tutorial series for steps to add a miner to your Agent. Miner's balance can be used as collateral.
...
See the [docs](/for-storage-providers/borrowing-limits-and-dtl) here for details.
...
![Borrow step](en-image-212.webp)

8. Click “**Send**” and approve the transaction in your wallet.

![Approve button](en-image-218.webp)
...
In [Part 5](/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-5-moving-fil-between-miner-and-agent) of this tutorial, we will show you how to move FIL from Miner to Agent and back.
