...
_If you don't yet understand the basics of GLIF Agents and the preparation steps to get started creating Agents on the GLIF website, we suggest you start by reading_ [_Part 1_](/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-1-preparation-setup) _of this tutorial. You can find all the tutorials about using Agents on the GLIF website on this_ [_page_](/troubleshooting/tutorials/for-storage-providers)_. You can find the instructions about the Agent's command on the **GLIF Command Line Interface** on this_ [_page_](https://github.com/glifio/glif?tab=readme-ov-file#agents---get-started-borrowing)_._
...
1. **Agent —** An Agent is a smart contract that borrows FIL from GLIF. You will deploy, own, and operate your Agent smart contract yourself (covered in this tutorial). In order to borrow FIL, your Agent needs collateral, which it gets by taking ownership of your Filecoin miner(s). A more detailed description of Agents can be found [here](/for-storage-providers/manage-miner-actors-with-agents).
...
**Step 1 —** go to [glif.io/agent](https://www.glif.io/en/agent) and click the “**Create new agent**” button on the left hand panel:

![Agent creation](en-image-366.webp)

***

**Step 2 —** Connect the “proposer” Filecoin Snap wallet you created in [Part 1](/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-1-preparation-setup) of the tutorial.

![Agent creation](en-image-348.webp)
...
![Approve button](en-image-387.webp)

Your FilSnap wallet needs some funds to perform the transactions required to create a new Agent.

If your wallet is empty, please make a deposit from another wallet using the “Deposit” button, or send funds to the wallet's address from an exchange. If you encounter any issues with the deposit, check the tutorial [here](/troubleshooting/tutorials/for-token-holders/transfer-fil-to-from-exchanges).

![Create your Agent on](en-image-388.webp)

***

**Step 3** — Enter your two additional wallet addresses (“approver”, “backup”) signers and create your Agent owner wallet. These are the two other FilSnap or Ledger wallet addresses you created in [Part 1](/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-1-preparation-setup) of this tutorial.

![Address input](en-image-389.webp)

If you want to use 2 signers only, open the owner settings, set 'Required approvals' to 2, and remove the “Signer 3”.

![Create your Agent on](en-image-351.webp)

Once you click “Create Owner”, you must approve the transaction in MetaMask:

![MetaMask prompt](en-image-352.webp)
...
![Create your Agent on](en-image-390.webp)
...
5. **Agent Operator** — the Agent Operator, to change this address, please refer to [Part 9](/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-9-change-operator-address) of this tutorial.

## Next Steps

Congratulations! You just created your GLIF Agent. To recap, in [Part 2](/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-2-create-your-agent) of this tutorial, you should have:
...
In [Part 3](/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-3-add-your-miner) of this tutorial, we will show you how to add miners to your Agent.
