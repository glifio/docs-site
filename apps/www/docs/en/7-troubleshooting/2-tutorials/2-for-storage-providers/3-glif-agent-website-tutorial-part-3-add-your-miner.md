...
![Tutorial step](en-image-368.webp)

## Step 2: Propose the “Add Miner” Proposal (Through website UI)

1. Connect to the wallet that is one of the signers of your multisig created in [Part 2](/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-2-create-your-agent).
...
![Send button](en-image-17.webp)

7. Approve the transaction in your wallet.

![Approval step](en-image-18.webp)
...
1. Connect with the other signer wallets. You can find all signer wallets in the “**Required Approvals**” section on your multisig page. These should be the same wallets used in [Part 2](/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-2-create-your-agent).

![Agent creation](en-image-24.webp)

2. Navigate to the “**Multisig**” tab.

![Approve proposal](en-image-22.webp)

3. The “**AddMiner**” proposal should appear in the “**Agent owner proposals**” queue.

![Add miner form](en-image-274.webp)

4. **Select the Proposal** that you just created.

![Approve proposal](en-image-26.webp)

5. Click **“Approve proposal”.**

![Proposal approval](en-image-27.webp)
...
![Add miner form](en-image-28.webp)
...
In [Part 4](/troubleshooting/tutorials/for-storage-providers/glif-agent-website-tutorial-part-4-borrow) of this tutorial, we will show you how to borrow FIL.
