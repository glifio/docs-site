...
Active GLIF+ cardholders receive higher borrowing limits, up to 10× leverage. See the [Tier Table](/glif-storage-providers-loyalty-rewards/tiers-and-limits) for exact limits per status.
...
2. You hold an active GLIF+ Loyalty Card (see activation steps in [next section](/glif-storage-providers-loyalty-rewards/how-to-join-glif-sp-program)).
3. You fund your Card with $GLF for cash back.

Once funded, up to 10% of every interest payment can be redeemed with your $GLF. The protocol swaps your $GLF into FIL at a premium determined by your tier—up to +25% for Gold members. See the [Tier Table](/glif-storage-providers-loyalty-rewards/tiers-and-limits) for details.
