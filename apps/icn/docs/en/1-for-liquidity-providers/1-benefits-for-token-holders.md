...
* GLIF issues [stICNT](/for-liquidity-providers/reward-mechanism-sticnt) tokens back to depositors, allowing them to get immediate liquidity on their tokens by swapping [stICNT](/for-liquidity-providers/reward-mechanism-sticnt) for ICNT through GLIF at any time. See [Unstaking](/for-liquidity-providers/unstaking).
* As staking rewards accrue, the value of $stICNT increases, so 1 stICNT will be worth more ICNT over time. See [Reward Mechanism - stICNT](/for-liquidity-providers/reward-mechanism-sticnt) for more details.
